...
const SERVICE_ACCOUNT_EMAIL = 'DJMiller@naperville203.org';


const privateKey = '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'
...
// Function to add slides to a pre-created slide deck
async function addSlidesToDeck() {
    const slides = google.slides({version: 'v1', auth: jwtClient});

    const presentationId = '1I8wsdiJ-i99HMjpwG2r8ijphJFUJDH93bqWoRwQhLqM'; // Replace with your presentation ID
    ...
    const requests = [
        {
            createSlide: {
                ...
                slideLayoutReference: {
                    predefinedLayout: 'TITLE_AND_TWO_COLUMNS' // Choose slide layout
                }
            }
        },
        {
    ...
    try {
        ...
        console.log('Slides added successfully:', response.data.replies);
    } catch (error) {
        console.error('Error adding slides:', error);
    }
}

// Authenticate and add slides
